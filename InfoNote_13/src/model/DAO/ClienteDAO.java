...
public class ClienteDAO {
	...
	public static Cliente inserir(String login, String senha, int tipo, String codigoCliente, String nome, String email,
		...
		try {
			...
			// Criação do insert
			String sql = "insert into cliente (codigocliente, nome, email, telefone, fklogin) values (?, ?, ?, ?, ?)";
	...
	public static Cliente buscarPorLoginSenha(String login, String senha) {
		...
		try {
			...
			String sql = "Select * from usuario u, cliente c where u.login=c.fklogin and u.login = ? and u.senha = ?";
