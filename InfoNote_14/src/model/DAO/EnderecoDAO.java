...
public class EnderecoDAO {
	...
	public static Endereco inserir(String logradouro, String numero, String complemento, String bairro, String cidade, String estado, String cep, String codigoCliente) {
		...
		try {
			...
			// criação do insert
			String sql = "insert into endereco (logradouro, numero, complemento, bairro, cidade, estado, cep, fkcodigocliente) values (?,?,?,?,?,?,?,?)";
			
			// Obter a conexao com o banco de dados
			Conexao conex = new Conexao(endDAO.url, endDAO.url, endDAO.login, endDAO.senha);
